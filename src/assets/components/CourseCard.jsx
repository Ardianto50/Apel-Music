...
const CourseCard = ({ image, kategori, judul, harga }) => {
  return (
    <Link to={"/"}>
      <div className="m-auto flex flex-col text-left gap-3 w-[360px] sm:w-[240px] lg:w-[360px] sm:min-h-[240px] min-h-[360px] lg:min-h-[350px] rounded-lg mb-10">
        <img src={image} alt="" className="h-40 lg:h-60 w-full rounded-lg" />
